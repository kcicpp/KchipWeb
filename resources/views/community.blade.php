                ...
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        ...
                        <div class="game-card rounded-xl p-8 text-center">
                            ...
                            <a href="https://discord.gg/MtYarnU4" class="glow-button bg-indigo-600 text-white px-6 py-3 rounded-full font-semibold">Tham Gia Discord</a>
                        </div>
                        ...
                        <div class="game-card rounded-xl p-8 text-center">
                            ...
                            <p class="inter text-blue-100 mb-6">Tham gia server Discord với hơn 18k thành viên yêu nhạc Sky</p>
                            <a href="https://www.facebook.com/groups/3562535747095288" class="glow-button bg-blue-600 text-white px-6 py-3 rounded-full font-semibold">Tham Gia Group</a>
                        </div>
                    </div>
