                ...
                <div class="game-card rounded-xl p-8">
                    ...
                    <form class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="password" class="w-full p-3 rounded-lg bg-white bg-opacity-20 text-white placeholder-blue-200 border border-white border-opacity-30" placeholder="Nhập mật khẩu">
                        </div>
